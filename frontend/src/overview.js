...
website.lesson.form.addEventListener('submit', (e) => {
  ...
  const form_data = new FormData(material_section);
  payload = {
...
function toggleEdit() {
  for (const element of website.edit) element.classList.toggle('hide');
}

function togglePopUp() {
  for (const element of website.popup) element.classList.toggle('hide');
}
